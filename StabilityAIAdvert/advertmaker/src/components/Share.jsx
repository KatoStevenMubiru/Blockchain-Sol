...
const Share = ({ imageData, textInput }) => {
 const url = "advertgenerator.vercell.app";

 return (
   <div className="share-container">
     <FacebookShareButton url={url} quote={textInput}>
     ...
     <WhatsappShareButton url={url} title={textInput} media={imageData}>
     ...
     <PinterestShareButton url={url} media={imageData}>
       <PinterestIcon size={32} round />
     </PinterestShareButton>

     <VKShareButton url={url} title={textInput} media={imageData}>
