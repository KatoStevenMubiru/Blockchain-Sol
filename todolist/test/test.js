  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      return auctionInstance.winners(0); // CODE HERE
    }).then(function(result) {
      /**********
      ...
      ***********/
      assert.notEqual(result, '0x0000000000000000000000000000000000000000', 'Winner address should not be the default address'); // CODE HERE
      /**********
